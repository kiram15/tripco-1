 ...
 public class Server {
     ...
     */
     ...
     private Object testing(Request rec, Response res) {
         ...
         String u = serveRec.getUnit();
         String o = serveRec.getOptSelection();
         ...
         if (serveRec.getRequest().equals("query")) {
            return serveQuery(serveRec.getDescription().get(0), miles, o);
         // see if the user is looking for the map:
        }
         else if(serveRec.getRequest().equals("upload")){

             return serveUpload(serveRec.getDescription(),miles, o);

        }
        else if(serveRec.getRequest().equals("plan")) {
            return servePlan(serveRec.getDescription(), miles, o);
        }
        else {
            return null;
        }
